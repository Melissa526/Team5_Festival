...
<body>
	...
	<div id="center">
		...
		<div id="div3" style="width: 350px; height: 400px; background-color: rgb(224, 224, 224);">
			<div>
			<br/><br/><br/>
			<input id="input2" type="text" readonly="readonly" value="kh정보교육원  12-1157-5125" style="width: 300px; height: 35px; text-align: center;">
			<br/><br/>
			<input id="input3" type="text" style="width: 60px; height: 40px;">
			<input id="input4" type="text" style="width: 60px; height: 40px;">
