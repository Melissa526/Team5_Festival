...
<!-- 페이징  -->
 <%
     ...
     ArrayList<MDBoardDto> list = dao.listBoard(from,to);
		...
		<div class="content">
			...
			<div class="table">
				<table class="table_board">
					...
					%>
					<tr>
						<td><input type="checkbox" name="chk" value="<%=list.get(i).getNum()%>" /></td>
						<td><%=list.get(i).getNum()%></td>
						<td><a href="event_boarddetail.jsp?seq=<%=list.get(i).getNum()%>"><%=list.get(i).getSubject()%></a></td>
					...
					<tr>
						<td colspan="6" align="right"><input type="button"
							value="글쓰기" onclick="location.href='event_boardinsert.jsp'" /> <input
