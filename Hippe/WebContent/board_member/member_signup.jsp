   ...
   <div id="center">
      <form action="../memberController.do" method="get" id="welcomeMember">
         ...
         <table> 
            ...
            <tr>
               <td colspan="1"><input type="password" placeholder="8자이상으로 입력해주세요" name="member_pw" required="required"></td>
            </tr>
            <tr>
               <td>비밀번호 확인</td>
            </tr>
            <tr>   
               <td colspan="1"><input type="password" placeholder="비밀번호를 다시 입력해주세요" id="pwChk" required="required"></td>
            </tr>
            <tr>
            ...
            <tr>   
               <td colspan="1"><input type="text" class="member_address" name="member_address_postcode" readonly="readonly" style="width: 100px;"></td>
            </tr>
            <tr>   
               <td colspan="1"><input type="text" class="member_address" name="member_address_doro" readonly="readonly" required="required"></td>
            </tr>
            <tr>   
               <td colspan="1"><input type="text" class="member_address" name="member_address_detail" readonly="readonly" required="required"></td>
            </tr>
            <tr>
               <td>이메일</td>
            </tr>
